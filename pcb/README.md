...
### IR Blaster
- IR LED driven by NPN transistor (2N2222/BC547) on GPIO 5
- 38 kHz carrier generated by RP2350 PIO for precise timing
- Supports NEC, Samsung, Sony SIRC, and RC5 protocols
- Automatic TV power on/off when PC wakes/sleeps (configurable)
- Optional IR receiver footprint (TSOP38238, GPIO 6) for future IR learning
...
| IR_LED | Through-hole pads | IR LED + driver circuit (mount near board edge for line-of-sight) |
...
| IR LED | TSAL6200 (940nm) | IR blaster emitter for TV control |
| NPN Transistor | 2N2222 / BC547 | IR LED current driver (~100mA peak) |
| Resistor | 1kΩ | NPN base current limit |
| Resistor | 22Ω | IR LED current limit |
...
See [WiFi, IR & Smart Home Design](../docs/wifi-ir-smarthome-design.md) for IR blaster circuit details, GPIO assignments, and smart home integration hardware requirements.
