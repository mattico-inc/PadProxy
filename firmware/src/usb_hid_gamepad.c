...
/*
 * Composite device: use the Interface Association Descriptor (IAD) class
 * codes so the OS groups the CDC interfaces correctly.
 */
...
static const char *desc_strings[] = {
    ...
    [3] = "000001",            /* Serial */
    [4] = "PadProxy Setup",    /* CDC interface name */
};
